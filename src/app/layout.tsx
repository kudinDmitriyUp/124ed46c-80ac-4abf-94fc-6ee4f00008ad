...
export const metadata: Metadata = {
  title: "Korean Essence Restaurant - Authentic Korean Cuisine",
  description: "Experience authentic Korean food at Korean Essence. Award-winning restaurant serving traditional dishes with fresh ingredients since 2016. Reserve your table today.",
  keywords: "Korean restaurant, authentic Korean food, bibimbap, bulgogi, kimchi, Korean cuisine, dining",
  metadataBase: new URL("https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764942654881-qsaneqmq.jpg"),
  alternates: {
    canonical: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764942654881-qsaneqmq.jpg"
  },
  openGraph: {
    title: "Korean Essence Restaurant",
    description: "Authentic Korean cuisine with traditional recipes and fresh ingredients",
    siteName: "Korean Essence",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764942654881-qsaneqmq.jpg",
      alt: "Korean Essence Restaurant"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "Korean Essence - Authentic Korean Restaurant",
    description: "Experience traditional Korean cuisine prepared with passion and fresh ingredients",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764942654881-qsaneqmq.jpg"]
  },
  robots: {
    index: true,
    follow: true
